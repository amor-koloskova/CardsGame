...
class MyViewController : UIViewController {
    override func loadView() {
        ...
        // прямоугольник
        //        view.layer.addSublayer(FillShape(size: CGSize(width: 200, height: 150), fillColor: UIColor.black.cgColor))
...
//        // анимированно возвращаем карточку в исходную позицию
...
//        }
    ...
    override func draw(_ rect: CGRect) {
        // удаляем добавленные раннее дочерние представления
    ...
    // возвращает представление с лицевой стороны карты
    private func getFrontSideView() -> UIView {
        ...
        // скругляем углы корневого представления
